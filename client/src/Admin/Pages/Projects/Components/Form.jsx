import ConnectionsIcon from '../../../../assets/Icons/Admin/Projects/connections.png';
import PuzzleIcon from '../../../../assets/Icons/Admin/Projects/puzzle.png';
...
function Form(project) {
        ...
        const form = [
                { name: "image", label: "Project image", value: image, backup: ImageIcon, type: "other", required: true, inputType: "image-input" },
                ...
                { name: "domains", label: "Domains", subLabel: "domain", values: domains, options: null, icon: ConnectionsIcon, type: "input", required: true, inputType: "tag-input" },
                { name: "features", label: "Features", subLabel: "feature", values: features, options: null, icon: PuzzleIcon, type: "input", required: false, inputType: "tag-input" },
