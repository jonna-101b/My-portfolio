...
import BriefCaseIcon from '../../../../assets/Icons/Admin/Profile/briefcase.png';
...
function MoreInfo() {
        ...
        const info = [
                ...
                { name: "professions", label: "Professions", subLabel: "profession", value: professions, type: "text", icon: BriefCaseIcon, inputType: "tag" },
